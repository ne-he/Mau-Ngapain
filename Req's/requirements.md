...
3. WHEN the local hour is between 05:00 and 11:59, THE Greeting_Widget SHALL display the greeting "Good Morning Name".
4. WHEN the local hour is between 12:00 and 16:59, THE Greeting_Widget SHALL display the greeting "Good Afternoon Name".
5. WHEN the local hour is between 17:00 and 20:59, THE Greeting_Widget SHALL display the greeting "Good Evening Name".
6. WHEN the local hour is between 21:00 and 04:59, THE Greeting_Widget SHALL display the greeting "Good Night Name".
7. WHERE a User_Motivation is stored in Local_Storage, THE Greeting_Widget SHALL append the User_Name to the greeting (e.g., "Good Morning Name, {Motivation}").
